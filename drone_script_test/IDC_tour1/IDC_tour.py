...
Authors: Michelle Park, adapted from Amy Chen's engineering_main
Date: 17 Sept 2016
Modified by: Jessica Cauchard
Date: 12 June 2017
----------------------------------------------------------
...
START_LAT = 32.1767383
START_LONG = 34.8369436

#INSTANCE VARIABLES
above_max_alt = False
num_waypoints = 4 #4 destinations
...
with KeyPoller() as keyPoller:
    ...
    #change variable num_waypoints at the top if we had any more data
    ...
    vehicle.commands.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 32.1771539, 34.8371442, TARGET_ALTITUDE))
    vehicle.commands.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 32.1769535, 34.8369598, TARGET_ALTITUDE))        
    vehicle.commands.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 32.1767383, 34.8369436, TARGET_ALTITUDE))
    vehicle.commands.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, 32.1769507, 34.8369971, TARGET_ALTITUDE))        
    #dummy waypoint
